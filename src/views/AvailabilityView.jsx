  ...
  return (
    <>
        ...
        <table style={{ minWidth: 680, borderCollapse: 'collapse', width: '100%' }}>
          <thead>
            <tr style={{ background: '#f0f0f0', borderBottom: '2px solid var(--line)' }}>
              <th style={{
                color: '#111', padding: '10px 16px', textAlign: 'left', minWidth: 130,
                fontSize: 13, fontWeight: 800, letterSpacing: '.5px', textTransform: 'uppercase',
              }}>Name</th>
              {DAYS.map(d => (
                <th key={d} style={{
                  color: '#111', textAlign: 'center', padding: '10px 8px', minWidth: 66,
                  fontSize: 13, fontWeight: 800, letterSpacing: '.5px', textTransform: 'uppercase',
                }}>{d}</th>
              ))}
              <th style={{
                color: '#555', textAlign: 'center', padding: '10px 8px', minWidth: 52,
          ...
          <tbody>
            {staffList.map((staff, si) => (
              <tr key={staff} style={{ background: si % 2 === 0 ? '#fff' : '#fdf5f8' }}>
                <td style={{ fontWeight: 700, fontSize: 14, padding: '4px 12px', borderRight: '1px solid var(--line)' }}>
                  {confirmDelete === staff ? (
                ...
                <td style={{ textAlign: 'center', fontWeight: 700, fontSize: 14, color: 'var(--red)', padding: '4px 10px' }}>
          ...
          <tfoot>
            <tr style={{ background: '#f0f0f0', borderTop: '2px solid var(--line)' }}>
              <td style={{ fontWeight: 700, fontSize: 12, padding: '6px 12px', color: '#555', textTransform: 'uppercase', letterSpacing: '.4px' }}>Available</td>
              {DAYS.map(d => {
                const n = daysAvail(d);
      ...
      <style>{`
        ...
        .avail-tick { font-size: 13px; font-weight: 900; color: transparent; transition: color .15s; line-height: 1; }
